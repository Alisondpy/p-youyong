...
!function(e, t, n) {
    ...
    var m = function(t, u) {
        ...
        u && e.extend(w, u);
        var T = w.container, $ = w.event, k = 0 === $.indexOf("scroll"), j = T && T !== a ? e(T) : s, C = function(t) {
            var i = m._list;
            if (i.length > 0) {
                var o = 0;
...
!function() {
    ...
    function n(n, i) {
        ...
        var $ = _ + A + T;
        a && ($ = "try{" + $ + "}catch(e){throw {filename:$filename,name:'Render Error',message:e.message,line:$line,source:" + t(n) + ".split(/\\n/)[$line-1].replace(/^\\s+/,'')};}");
        try {
            var k = new Function("$data", "$filename", $);
        ...
        switch (n) {
          ...
          default:
            if (/^\s*\|\s*[\w\$]/.test(o)) {
                ...
                for (var f = 0, d = e.split("|"), p = d.length, h = d[f++]; p > f; f++) h = $(h, d[f]);
                e = (c ? "=" : "=#") + h;
...
define("lib/ui/box/1.0.1/popup", [ "require", "exports", "module", "jquery", "../../../core/1.0.0/utils/util", "../../../core/1.0.0/utils/css", "../../../core/1.0.0/event/emitter" ], function(e, t, n) {
    ...
    r.inherits(i, s, {
        ...
        show: function(e, t) {
            ...
            if (void 0 !== r) {
                n = typeof r;
                "boolean" === n ? t.modal = r : r && "object" === n && ($(r) || $(r.target) ? s = r : x(t, r));
            }
        ...
        alignTo: function(e, t) {
            ...
            var f = n._dirClass;
            f && r.removeClass(f);
            var d = i.fixed, p = E(), h = j(), m = I(r), g = N(r), b = z(e), x = I(a), _ = N(a), A = b.left, $ = b.top, k = d ? A - h.x : A, C = d ? $ - h.y : $, q = d ? 0 : h.x, L = d ? 0 : h.y, S = q + p.w - m, D = L + p.h - g, U = {
                t: "b",
                b: "t",
                l: "r",
                r: "l"
...
define("conf/open-class-detail", [ "require", "exports", "module", "jquery", "module/top-search/1.0.0/top-search", "module/login-status/1.0.0/login-status", "module/login-status/1.0.0/login", "module/fix-bar/1.0.0/fix-bar", "module/footer/1.0.0/footer", "lib/core/1.0.0/utils/form", "template", "lib/core/1.0.0/io/request", "lib/ui/box/1.0.1/crossbox" ], function(e, t, n) {
    "use strict";
    var i = e("jquery"), o = e("module/top-search/1.0.0/top-search"), r = e("module/login-status/1.0.0/login-status"), a = e("module/login-status/1.0.0/login"), s = e("module/fix-bar/1.0.0/fix-bar"), u = e("module/footer/1.0.0/footer"), l = (new o(), 
    new r(), new s(), new u(), a.isLogin()), c = (e("lib/core/1.0.0/utils/form"), e("template"), 
    e("lib/core/1.0.0/io/request"), e("lib/ui/box/1.0.1/crossbox"));
