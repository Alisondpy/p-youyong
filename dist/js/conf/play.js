...
define("lib/core/1.0.0/utils/util", [ "require", "exports", "module" ], function(e, t, i) {
    ...
    function c(e, t) {
        if (!t || !n(t)) return e;
        for (var i = y(t), o = i.length; o--; ) e[i[o]] = t[i[o]];
        return e;
    }
    function f(e) {
...
!function(e, t, i) {
    ...
    var y = function(t, l) {
        ...
        l && e.extend(x, l);
        var A = x.container, C = x.event, j = 0 === C.indexOf("scroll"), k = A && A !== a ? e(A) : s, L = function(t) {
            var n = y._list;
            if (n.length > 0) {
                var o = 0;
                i(n.slice(0), function(t, i) {
                    var n = e(i);
                    if (!x.skipInvisible || n.is(":visible")) if (_(i, x) || b(i, x)) ; else if (v(i, x) || g(i, x)) {
            ...
            if (s === f) {
                ...
                o && (n = o(n, t));
                r && r.apply(y, [ t, n ]);
                T.call(y, t, n, x, function(e, o) {
                    if (!y._destroyed) {
                        a && i.removeClass(a);
                        if (e) setTimeout(function() {
                            t[c] = f;
                            y.emit("lazyItemError", t, n, e);
                            t = null;
                        }, 300); else {
                            t[c] = p;
                            E();
                            y.emit("lazyItemReady", t, n, o);
                            var r = x.load;
                            r && r.apply(y, [ t, n, o ]);
                            t = null;
                        }
            ...
            if (n) if (i.is("img")) {
                var o = i.attr("src");
                o || i.attr("src", n);
            } else "image" === y._.type || i.children()[0] || i.html(n);
            i.on("appear", I);
            j || i.on(C, $);
            y._list.push(t);
        }, S = function(e) {
        ...
        y.on("lazyItemReady", function(e) {
            z(e);
        });
        y.once("destroy", function() {
            S = null;
            L = null;
            E = null;
            I = null;
    ...
    var v = function(t, i) {
        ...
        return !(g(e, t) || b(e, t) || v(e, t) || _(e, t));
    };
    y.belowthefold = v;
    y.rightoffold = g;
    y.abovethetop = _;
...
define("lib/ui/box/1.0.1/drag", [ "require", "jquery" ], function(e) {
    ...
    d.create = function(e, o, r) {
        ...
        var a, s, l, c, f = t(e), p = r.hook ? t(r.hook) : f, h = new d(), m = d.types.start, y = e.className.replace(/^\s|\s.*/g, "") + "-drag-start", v = {
            off: function() {
                p.off(m, h.start);
            }
        };
        h.onstart = function(t) {
            ...
            var m = f.offset(), v = this.startLeft = o ? m.left - u : m.left, g = this.startTop = o ? m.top - d : m.top;
...
!function(e, t) {
    ...
    }(), p = 1, h = 2, m = 0, y = 1, v = 2, g = function(e, t, i) {
        var n = [];
        n[m] = e;
        n[y] = t;
        n[v] = i;
    ...
    _.removeListener = function(e, t, i) {
        ...
        for (;o = e.shift(); ) {
            ...
            if (r) if (t || i) for (a = r.length; --a >= 0; ) {
                l = r[a];
                c = l[m];
                t && c !== t && (void 0 === c.guid || c.guid !== t.guid) || i && l[y] !== i || r.splice(a, 1);
            } else delete n[o];
        }
        return this;
    };
...
define("lib/core/1.0.0/utils/css", [ "require", "exports", "module", "jquery", "./util" ], function(e, t, i) {
    ...
    var u = e("jquery"), c = e("./util"), f = (c.each, c.noop), d = c.setImmediate, p = a(), h = /\-v\-/g, m = document.getElementsByTagName("head")[0].appendChild(n("style")), y = m.sheet || m.styleSheet, v = {
...
define("lib/ui/box/1.0.1/popup", [ "require", "exports", "module", "jquery", "../../../core/1.0.0/utils/util", "../../../core/1.0.0/utils/css", "../../../core/1.0.0/event/emitter" ], function(e, t, i) {
    ...
    var o = e("jquery"), r = e("../../../core/1.0.0/utils/util"), a = e("../../../core/1.0.0/utils/css"), s = e("../../../core/1.0.0/event/emitter"), l = window, u = l.document, c = o(l), f = o(u), d = u.documentElement, p = /\S+/g, h = !("minWidth" in d.style), m = "ui-layer", y = l.Math, v = y.max, g = y.ceil, _ = r.guid, b = r.extend, x = r.each, w = function(e, t) {
    ...
    r.inherits(n, s, {
        ...
        center: function() {
            var e = this._popup, t = this._.fixed, i = k(), n = E(), o = L(e), r = t ? 0 : i.x, a = t ? 0 : i.y, s = (n.w - o.w) / 2 + r, l = .382 * (n.h - o.h) + a;
            e.css({
                left: v(A(s), r),
                top: v(A(l), a)
            });
        ...
        alignTo: function(e, t) {
            ...
            var f = i._dirClass;
            f && r.removeClass(f);
            var d = n.fixed, p = E(), h = k(), y = q(r), v = S(r), _ = I(e), b = q(a), w = S(a), T = _.left, C = _.top, j = d ? T - h.x : T, L = d ? C - h.y : C, $ = d ? 0 : h.x, P = d ? 0 : h.y, O = $ + p.w - y, D = P + p.h - v, F = {
                t: "b",
                b: "t",
                l: "r",
                r: "l"
...
!function() {
    ...
    function i(i, n) {
        ...
        function r(t) {
            ...
            return a && (t = "$line=" + i + ";" + t), v(e(t), function(e) {
                if (e && !m[e]) {
                    var t;
...
define("module/monitor/1.0.0/question", [ "require", "exports", "module", "jquery", "./../../../plugins/polling-list/1.0.0/polling-list", "lib/core/1.0.0/io/request", "lib/core/1.0.0/event/emitter", "lib/core/1.0.0/utils/util", "template" ], function(e, t, i) {
    ...
    n.prototype._initMouse = function() {
        var e = this;
        if (!e._initMouseInited) {
            e._initMouseInited = !0;
    ...
    n.prototype._initEvent = function() {
        ...
        e.pollingList.on("success", function(t) {
            if (t && t.data && t.data.resultList && t.data.resultList.length > 0) {
                e._initMouse();
                e.min = t.data.resultList[t.data.resultList.length - 1].id;
        ...
        e.pollingList.on("pullup", function(i) {
            if (!e._isPulling) {
                e._isPulling = !0;
                a[t.type](t.url, o.extend({}, t.data, {
                    id: e.min
                }), function(t) {
                    if (t && t.data && t.data.resultList && t.data.resultList.length > 0) {
                        e.min = t.data.resultList[t.data.resultList.length - 1].id;
    ...
    var CKobject = {
        ...
        getpath: function(e) {
            ...
            if (0 == c) if ("/" == e.substr(0, 1)) u = a + e; else {
                ...
                var n = e.replace("../", "./"), a = n.split("./"), h = a.length, f = n.replace("./", ""), m = l.split("/"), y = m.length - h;
                for (i = 0; i < y; i++) u += m[i] + "/";
                u += f;
            } else u = e;
            return u;
        ...
        embedSWF: function(e, t, i, n, o, r, a) {
            ...
            }, h = typeof u.getElementById != s && typeof u.getElementsByTagName != s && typeof u.createElement != s, m = 'id="' + i + '" name="' + i + '" ', y = "", v = "";
            a.movie = e;
            ...
            y += '<object pluginspage="http://www.macromedia.com/go/getflashplayer" ';
            y += 'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" ';
            y += 'codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=11,3,0,0" ';
            y += 'width="' + n + '" ';
            y += 'height="' + o + '" ';
            y += m;
            y += 'align="middle">';
            ...
            y += "<embed ";
            y += this.getparam(a).w;
            y += ' width="' + n + '" height="' + o + '" name="' + i + '" id="' + i + '" align="middle" ' + m;
            y += 'type="application/x-shockwave-flash" pluginspage="' + c + '" />';
            y += "</object>";
...
define("conf/play", [ "require", "exports", "module", "jquery", "module/top-search/1.0.0/top-search", "module/login-status/1.0.0/login-status", "module/fix-bar/1.0.0/fix-bar", "module/footer/1.0.0/footer", "lib/ui/box/1.0.1/crossbox", "lib/plugins/lazyload/1.9.3/lazyload", "lib/core/1.0.0/io/request", "lib/ui/tab/1.0.0/tab", "template", "module/monitor/1.0.0/question", "module/monitor/1.0.0/note", "module/login-status/1.0.0/login", "plugins/layer/layer", "plugins/ckplayer/6.7.0/player" ], function(e, t, i) {
    ...
    new c(), new f(), new d(), e("lib/ui/box/1.0.1/crossbox")), h = e("lib/plugins/lazyload/1.9.3/lazyload"), m = e("lib/core/1.0.0/io/request"), y = e("lib/ui/tab/1.0.0/tab"), v = e("template"), g = e("module/monitor/1.0.0/question"), _ = e("module/monitor/1.0.0/note"), b = e("module/login-status/1.0.0/login"), x = (l(".jMod-catlog"), 
    l("#jTab"));
    e("plugins/layer/layer");
    var w, T, A, C = new y(x), j = l("#jQuestionTab1"), k = l("#jQuestionTab2"), L = l("#jNoteTab1"), E = l("#jNoteTab2"), I = $PAGE_DATA.courseId, $ = $PAGE_DATA.lessonId, q = $PAGE_DATA.examId, S = e("plugins/ckplayer/6.7.0/player"), P = new S("#jAudio", {
        swfPlayer: $PAGE_DATA.ckplayer,
        embed: {
            width: "871",
            height: "655"
