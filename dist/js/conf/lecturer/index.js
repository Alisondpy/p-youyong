...
define("lib/ui/box/1.0.1/popup", [ "require", "exports", "module", "jquery", "../../../core/1.0.0/utils/util", "../../../core/1.0.0/utils/css", "../../../core/1.0.0/event/emitter" ], function(e, t, n) {
    ...
    r.inherits(i, s, {
        ...
        alignTo: function(e, t) {
            ...
            var f = n._dirClass;
            f && r.removeClass(f);
            var d = i.fixed, p = E(), h = k(), v = I(r), m = q(r), b = P(e), x = I(a), _ = q(a), C = b.left, T = b.top, j = d ? C - h.x : C, $ = d ? T - h.y : T, z = d ? 0 : h.x, S = d ? 0 : h.y, D = z + p.w - v, L = S + p.h - m, M = {
                t: "b",
                b: "t",
                l: "r",
                r: "l"
...
define("conf/lecturer/index", [ "require", "exports", "module", "jquery", "lib/ui/box/1.0.1/box", "lib/plugins/lazyload/1.9.3/lazyload", "lib/core/1.0.0/io/request", "template", "plugins/pager/1.0.0/pager", "module/navigation-bar/1.0.0/navigation-bar", "module/top-search/1.0.0/top-search", "module/login-status/1.0.0/login-status", "module/fix-bar/1.0.0/fix-bar", "module/footer/1.0.0/footer" ], function(e, t, n) {
    "use strict";
    ...
    function o() {
        var e = {}, t = s("#jNavType"), n = t.attr("name"), o = t.find(".current").attr("data-value");
        e[n] = o;
        i($PAGE_DATA.pagerTeacher, e, "lists", "jLists", p);
    }
    var r, a, s = e("jquery"), u = e("lib/ui/box/1.0.1/box"), l = e("lib/plugins/lazyload/1.9.3/lazyload"), c = (e("lib/core/1.0.0/io/request"), 
    e("template")), f = e("plugins/pager/1.0.0/pager"), d = e("module/navigation-bar/1.0.0/navigation-bar"), p = s("#jPagination"), h = e("module/top-search/1.0.0/top-search"), g = e("module/login-status/1.0.0/login-status"), v = e("module/fix-bar/1.0.0/fix-bar"), m = e("module/footer/1.0.0/footer");
    new h(), new g(), new v(), new m();
    o();
    var y = new d("#jCourseNav", {
        currentClass: "current",
        navSelector: [ "#jNavType" ]
    });
