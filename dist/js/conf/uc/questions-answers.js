...
!function(e, t, n) {
    ...
    var v = function(t, u) {
        ...
        r(v);
        var _ = u.type || w.type, A = g.get(_);
        if ("function" != typeof A) throw "Error, cannot found the specific type loader (type: `" + _ + "`)";
        "html" === _ && (w.placeholder = "");
        u && e.extend(w, u);
        var C = w.container, T = w.event, j = 0 === T.indexOf("scroll"), k = C && C !== a ? e(C) : s, $ = function(t) {
            var i = v._list;
            if (i.length > 0) {
                var o = 0;
...
define("lib/ui/box/1.0.1/popup", [ "require", "exports", "module", "jquery", "../../../core/1.0.0/utils/util", "../../../core/1.0.0/utils/css", "../../../core/1.0.0/event/emitter" ], function(e, t, n) {
    ...
    r.inherits(i, s, {
        ...
        center: function() {
            var e = this._popup, t = this._.fixed, n = k(), i = P(), o = $(e), r = t ? 0 : n.x, a = t ? 0 : n.y, s = (i.w - o.w) / 2 + r, u = .382 * (i.h - o.h) + a;
            e.css({
                left: m(C(s), r),
                top: m(C(u), a)
            });
        ...
        alignTo: function(e, t) {
            ...
            var f = n._dirClass;
            f && r.removeClass(f);
            var d = i.fixed, p = P(), h = k(), v = I(r), m = q(r), b = E(e), x = I(a), _ = q(a), A = b.left, T = b.top, j = d ? A - h.x : A, $ = d ? T - h.y : T, z = d ? 0 : h.x, S = d ? 0 : h.y, L = z + p.w - v, N = S + p.h - m, M = {
                t: "b",
                b: "t",
                l: "r",
                r: "l"
            ...
            var Q, Y, X = "top" !== O[B], J = [ "v", "h" ][1 ^ X], Z = I(H), K = q(H), ee = {}, te = X ? "left" : "top";
            switch (J) {
              case "h":
                Q = y(A + (x - Z) / 2);
                ee.left = Q;
...
!function() {
    function e(e) {
        return e.replace(b, "").replace(x, ",").replace(w, "").replace(_, "").replace(A, "").split(C);
    }
    function t(e) {
...
define("conf/uc/questions-answers", [ "require", "exports", "module", "jquery", "module/top-search/1.0.0/top-search", "module/login-status/1.0.0/login-status", "module/login-status/1.0.0/login", "module/fix-bar/1.0.0/fix-bar", "module/footer/1.0.0/footer", "lib/ui/box/1.0.1/box", "lib/plugins/lazyload/1.9.3/lazyload", "plugins/pager/1.0.0/pager", "module/login-status/1.0.0/login", "lib/core/1.0.0/io/request", "template" ], function(e, t, n) {
    "use strict";
    function i(e, t, n, i, o) {
        "undefined" != typeof s && s.destroy();
        s = new v(o, {
            url: e,
            data: t
        });
        var r = null;
        s.on("ajaxStart", function() {
            r = h.loading("正在加载...", {
                modal: !1
            });
        });
    ...
    var a, s, u = e("jquery"), l = e("module/top-search/1.0.0/top-search"), c = e("module/login-status/1.0.0/login-status"), f = e("module/login-status/1.0.0/login"), d = e("module/fix-bar/1.0.0/fix-bar"), p = e("module/footer/1.0.0/footer"), h = (new l(), 
    new c(), new d(), new p(), e("lib/ui/box/1.0.1/box")), g = e("lib/plugins/lazyload/1.9.3/lazyload"), v = e("plugins/pager/1.0.0/pager"), f = e("module/login-status/1.0.0/login"), m = e("lib/core/1.0.0/io/request"), y = e("template"), b = (u("#jMain"), 
    u("#jContainer")), x = u("#jPagination");
    a = new g(u(".jImg"), {
        mouseWheel: !0,
        effect: "fadeIn",
        snap: !0
    ...
    var w;
    o();
    var _ = u("#jMain"), A = u(".jPublish"), C = u(".jArrow"), T = u(".jTxtNum"), j = u(".jTxt");
    _.on("input propertychange", ".jTxt", function() {
        var e = j.val().length;
        if (e > 300) {
            u(this).addClass("text-error");
            A.addClass("publish-error");
            C.addClass("arrow-error");
            T.css({
                color: "red"
            });
        } else {
            u(this).removeClass("text-error");
            A.removeClass("publish-error");
            C.removeClass("arrow-error");
            T.css({
                color: "#666"
            });
        }
    ...
    _.on("click", ".jPublish", function() {
        if (f.isLogin()) {
            var e = j.val();
            "" == e ? h.error("请输入发表内容") : u(this).hasClass("publish-error") || m.get($PAGE_DATA.submitAnswer, {
                questionId: w,
                answerId: 0,
                content: e
            }, function(e) {
        ...
        } else f.login(window.location.href);
    });
    _.on("focus", ".jTxt", function() {
        u(".jArrow").addClass("arrow-focus");
        u(this).addClass("text-focus").attr("placeholder", "");
        u(this).css("color", "#333");
    }).on("blur", ".jTxt", function() {
        if ("" === u(this).val()) {
            u(this).removeClass("text-focus").attr("placeholder", "看点糟点，不吐不快！别憋着，马上大声说出来吧！");
            u(".jArrow").removeClass("arrow-focus");
            u(this).css("color", "#ccc");
        }
    });
    _.on("click", "#jLike", function() {
        if (f.isLogin()) {
            var e, t = u(this).attr("data-dataType"), n = u(this).attr("data-type"), i = u(this).attr("data-id");
            if (u(this).hasClass("activeLike")) {
                e = {
                    dataType: t,
                    type: n,
                    id: i
                };
                r($PAGE_DATA.commentClickUrl, e, "取消点赞");
            } else {
                e = {
                    dataType: t,
                    type: n,
                ...
                r($PAGE_DATA.commentClickUrl, e, "点赞");
            }
        } else f.login(window.location.href);
    });
});