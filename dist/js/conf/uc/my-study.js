...
define("lib/ui/box/1.0.1/popup", [ "require", "exports", "module", "jquery", "../../../core/1.0.0/utils/util", "../../../core/1.0.0/utils/css", "../../../core/1.0.0/event/emitter" ], function(e, t, n) {
    ...
    r.inherits(i, s, {
        ...
        alignTo: function(e, t) {
            ...
            var Q, Y, X = "top" !== O[F], J = [ "v", "h" ][1 ^ X], Z = z(H), K = q(H), ee = {}, te = X ? "left" : "top";
            switch (J) {
              case "h":
                Q = y(C + (x - Z) / 2);
                ee.left = Q;
...
define("conf/uc/my-study", [ "require", "exports", "module", "jquery", "./common", "lib/ui/box/1.0.1/box", "lib/plugins/lazyload/1.9.3/lazyload", "lib/core/1.0.0/io/request", "lib/core/1.0.0/dom/build", "plugins/pager/1.0.0/pager", "template", "lib/ui/tab/1.0.0/tab" ], function(e, t, n) {
    "use strict";
    var i = e("jquery");
    e("./common");
    var o, r = e("lib/ui/box/1.0.1/box"), a = e("lib/plugins/lazyload/1.9.3/lazyload"), s = e("lib/core/1.0.0/io/request"), u = e("lib/core/1.0.0/dom/build"), l = e("plugins/pager/1.0.0/pager"), c = e("template"), f = e("lib/ui/tab/1.0.0/tab"), d = i("#jIfmTab"), p = new f(d), h = {};
    h.callback1 = function(e) {
        var t = !1;
        if (!h.callback1.isInited) {
            h.callback1.isInited = !0;
            var n = u.build(e, !1), f = n.get("jPagination"), d = n.get("jContainer"), p = new l(f, {
                url: $PAGE_DATA.getPager,
                data: {}
            }), g = null;
            p.on("ajaxStart", function() {
                g = r.loading("正在加载...", {
                    modal: !1
                });
            });
            p.on("ajaxSuccess", function(n, r) {
                if (n && n.data && n.data.resultList && n.data.resultList.length > 0) {
                    if (t) {
                        n.data.deletingClass = "deleting";
                        n.data.deletingTxt = "完成";
                    } else {
                        n.data.deletingClass = "";
                        n.data.deletingTxt = "管理";
                    }
                    d.html(c("jModule", n.data));
                    o = new a(i(".jImg"), {
                        mouseWheel: !0,
                        effect: "fadeIn",
                        snap: !0
            ...
            p.on("ajaxError", function(e) {
                r.warn(e.msg || "网络错误，请重试！");
                g && g.hide();
            });
        }
        var v = {
            init: function(e, n) {
                if (!v.inited) {
                    ...
                    e.on("click", ".jBtnManage", function() {
                        var n = e.find(".jItem"), o = i(this);
                        if (t) {
                            t = !1;
                            o.removeClass("deleting").html("管理");
                            n.removeClass("deleting");
                        } else {
                            t = !0;
                            o.addClass("deleting").html("完成");
                            n.addClass("deleting");
                        }
                    });
                    e.on("click", ".jControl .jDel", function() {
                        var e = i(this).attr("data-id");
                        r.confirm("确定删除吗？", function() {
                            s.get($PAGE_DATA.delInfo, {
                                id: e
                            }, function(e) {
                                t = !0;
                                r.ok("删除成功!");
                                n.pagination.selectPage(n.pagination.get("currentPage"));
                            }, function(e) {
