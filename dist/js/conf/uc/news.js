...
define("lib/ui/box/1.0.1/popup", [ "require", "exports", "module", "jquery", "../../../core/1.0.0/utils/util", "../../../core/1.0.0/utils/css", "../../../core/1.0.0/event/emitter" ], function(e, t, n) {
    ...
    r.inherits(i, s, {
        ...
        alignTo: function(e, t) {
            ...
            var Q, Y, X = "top" !== O[F], J = [ "v", "h" ][1 ^ X], Z = I(H), K = q(H), ee = {}, te = X ? "left" : "top";
            switch (J) {
              case "h":
                Q = y(C + (x - Z) / 2);
                ee.left = Q;
...
define("conf/uc/news", [ "require", "exports", "module", "jquery", "./common", "lib/ui/box/1.0.1/box", "lib/plugins/lazyload/1.9.3/lazyload", "lib/core/1.0.0/io/request", "lib/core/1.0.0/dom/build", "plugins/pager/1.0.0/pager", "template", "lib/ui/tab/1.0.0/tab" ], function(e, t, n) {
    "use strict";
    var i = e("jquery");
    e("./common");
    var o = e("lib/ui/box/1.0.1/box"), r = (e("lib/plugins/lazyload/1.9.3/lazyload"), 
    e("lib/core/1.0.0/io/request"), e("lib/core/1.0.0/dom/build")), a = e("plugins/pager/1.0.0/pager"), s = e("template"), u = e("lib/ui/tab/1.0.0/tab"), l = i("#jIfmTab"), c = new u(l), f = {};
    f.callback1 = function(e) {
        if (!f.callback1.isInited) {
            f.callback1.isInited = !0;
            var t = r.build(e, !1), n = t.get("jPagination"), u = t.get("jContainer");
            "undefined" != typeof l && l.destroy();
            var l = new a(n, {
