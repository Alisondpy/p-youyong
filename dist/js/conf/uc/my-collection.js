...
!function(e, t, n) {
    ...
    var v = function(t, u) {
        ...
        u && e.extend(_, u);
        var A = _.container, j = _.event, k = 0 === j.indexOf("scroll"), T = A && A !== a ? e(A) : s, P = function(t) {
            var i = v._list;
            if (i.length > 0) {
                var o = 0;
...
define("lib/ui/box/1.0.1/popup", [ "require", "exports", "module", "jquery", "../../../core/1.0.0/utils/util", "../../../core/1.0.0/utils/css", "../../../core/1.0.0/event/emitter" ], function(e, t, n) {
    ...
    var o = e("jquery"), r = e("../../../core/1.0.0/utils/util"), a = e("../../../core/1.0.0/utils/css"), s = e("../../../core/1.0.0/event/emitter"), u = window, l = u.document, c = o(u), f = o(l), d = l.documentElement, p = /\S+/g, h = !("minWidth" in d.style), g = "ui-layer", v = u.Math, m = v.max, y = v.ceil, b = r.guid, x = r.extend, _ = r.each, w = function(e, t) {
        ...
        var r = i.defaultView || i.parentWindow, a = r.frameElement, s = T(), l = o(a).offset();
        return {
    ...
    r.inherits(i, s, {
        ...
        show: function(e, t) {
            ...
            if (void 0 !== r) {
                n = typeof r;
                "boolean" === n ? t.modal = r : r && "object" === n && (j(r) || j(r.target) ? s = r : x(t, r));
            }
        ...
        center: function() {
            var e = this._popup, t = this._.fixed, n = T(), i = E(), o = P(e), r = t ? 0 : n.x, a = t ? 0 : n.y, s = (i.w - o.w) / 2 + r, u = .382 * (i.h - o.h) + a;
            e.css({
                left: m(A(s), r),
                top: m(A(u), a)
            });
        ...
        alignTo: function(e, t) {
            ...
            var f = n._dirClass;
            f && r.removeClass(f);
            var d = i.fixed, p = E(), h = T(), v = q(r), m = S(r), b = I(e), x = q(a), w = S(a), C = b.left, j = b.top, k = d ? C - h.x : C, P = d ? j - h.y : j, z = d ? 0 : h.x, D = d ? 0 : h.y, N = z + p.w - v, $ = D + p.h - m, M = {
                t: "b",
                b: "t",
                l: "r",
                r: "l"
            ...
            var Q, Y, X = "top" !== U[B], J = [ "v", "h" ][1 ^ X], Z = q(F), K = S(F), ee = {}, te = X ? "left" : "top";
            switch (J) {
              case "h":
                Q = y(C + (x - Z) / 2);
                ee.left = Q;
...
define("conf/uc/my-collection", [ "require", "exports", "module", "jquery", "./common", "lib/ui/box/1.0.1/box", "lib/plugins/lazyload/1.9.3/lazyload", "lib/core/1.0.0/io/request", "lib/core/1.0.0/dom/build", "plugins/pager/1.0.0/pager", "module/uc/search-bar/search-bar", "lib/ui/tab/1.0.0/tab" ], function(e, t, n) {
    "use strict";
    function i(e) {
        for (var t = "", n = 0; n < e.length; n++) t += "<div>" + e[n] + "</div>";
        "" == t && (t = "<div>数据为空</div>");
        return t;
    }
    var o = e("jquery");
    e("./common");
    var r = e("lib/ui/box/1.0.1/box"), a = e("lib/plugins/lazyload/1.9.3/lazyload"), s = (e("lib/core/1.0.0/io/request"), 
    e("lib/core/1.0.0/dom/build")), u = e("plugins/pager/1.0.0/pager"), l = e("module/uc/search-bar/search-bar"), c = new l("#jUcSearchBar");
    c.on("search", function(e) {
        console.log("你可以根据这个返回值来做业务:", e);
    });
    var f = e("lib/ui/tab/1.0.0/tab"), d = o("#jIfmTab"), p = new f(d), h = {};
    h.callback1 = function(e) {
        if (!h.callback1.isInited) {
            h.callback1.isInited = !0;
            var t = s.build(e, !1), n = t.get("jPagination"), l = t.get("jContainer");
            l.on("click", ".jBtn", function() {
                console.log(0);
            });
            var c = new u(n, {
    ...
    h.callback2 = function(e) {
        if (!h.callback2.isInited) {
            h.callback2.isInited = !0;
            var t = s.build(e, !1), n = t.get("jPagination"), l = t.get("jContainer");
            l.on("click", ".jBtn", function() {
                console.log(0);
            });
    ...
    h.callback3 = function(e) {
        if (!h.callback3.isInited) {
            h.callback3.isInited = !0;
            var t = s.build(e, !1), n = t.get("jPagination"), l = t.get("jContainer");
            l.on("click", ".jBtn", function() {
                console.log(0);
            });
    ...
    p.on("change", function(e) {
        ...
        h["callback" + t] && h["callback" + t](e.body);
    });
    p.setCurrent();
});