...
define("conf/uc/class", [ "require", "exports", "module", "jquery", "./common", "lib/ui/box/1.0.1/box", "lib/core/1.0.0/io/request", "lib/core/1.0.0/dom/build", "plugins/pager/1.0.0/pager", "lib/ui/tab/1.0.0/tab", "template" ], function(e, t, n) {
    "use strict";
    var i = e("jquery");
    e("./common");
    var o = e("lib/ui/box/1.0.1/box"), r = (e("lib/core/1.0.0/io/request"), e("lib/core/1.0.0/dom/build")), a = e("plugins/pager/1.0.0/pager"), s = e("lib/ui/tab/1.0.0/tab"), u = e("template"), l = i("#jIfmTab"), c = new s(l), f = {};
    f.callback1 = function(e) {
        if (!f.callback1.isInited) {
            f.callback1.isInited = !0;
            var t = r.build(e, !1), n = t.get("jPagination"), s = t.get("jContainer"), l = new a(n, {
                url: $PAGE_DATA.getPager,
                data: {
                    type: 1
                }
            }), c = null;
            l.on("ajaxStart", function() {
                c = o.loading("正在加载...", {
                    modal: !1
                });
            });
            l.on("ajaxSuccess", function(e, t) {
                if (e && e.data && e.data.resultList && e.data.resultList.length > 0) {
                    s.html(u("tClass1", e.data));
                    t && t(e.data.records);
                } else s.html(u("tEmpty"));
                c && c.hide();
            });
            l.on("ajaxError", function(e) {
    ...
    f.callback2 = function(e) {
        if (!f.callback2.isInited) {
            f.callback2.isInited = !0;
            var t = r.build(e, !1), n = t.get("jPagination"), s = t.get("jContainer"), l = new a(n, {
                url: $PAGE_DATA.getPager,
                data: {
                    type: 3
    ...
    c.on("change", function(e) {
        ...
        f["callback" + t] && f["callback" + t](e.body);
    });
    c.setCurrent();
});