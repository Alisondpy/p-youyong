...
!function(e, t, n) {
    ...
    var g = function(t, u) {
        ...
        u && e.extend(w, u);
        var A = w.container, j = w.event, T = 0 === j.indexOf("scroll"), k = A && A !== a ? e(A) : s, E = function(t) {
            var i = g._list;
            if (i.length > 0) {
                var o = 0;
...
define("lib/ui/box/1.0.1/popup", [ "require", "exports", "module", "jquery", "../../../core/1.0.0/utils/util", "../../../core/1.0.0/utils/css", "../../../core/1.0.0/event/emitter" ], function(e, t, n) {
    ...
    r.inherits(i, s, {
        ...
        center: function() {
            var e = this._popup, t = this._.fixed, n = k(), i = $(), o = E(e), r = t ? 0 : n.x, a = t ? 0 : n.y, s = (i.w - o.w) / 2 + r, u = .382 * (i.h - o.h) + a;
            e.css({
                left: m(A(s), r),
                top: m(A(u), a)
            });
        ...
        alignTo: function(e, t) {
            ...
            r.css(U).addClass(H);
            n._dirClass = H;
            var B = n.$("arrow", 1), V = n.$("inner", 1);
            if (!B) {
                if (!V) return n;
                B = o('<div node-type="arrow" class="ui-arrow"><i></i><b></b></div>').appendTo(V);
            }
            var Q, Y, X = "top" !== O[F], J = [ "v", "h" ][1 ^ X], Z = z(B), K = q(B), ee = {}, te = X ? "left" : "top";
            switch (J) {
              case "h":
                Q = y(C + (x - Z) / 2);
                ee.left = Q;
...
!function() {
    ...
    function n(n, i) {
        ...
        var j = _ + C + A;
        a && (j = "try{" + j + "}catch(e){throw {filename:$filename,name:'Render Error',message:e.message,line:$line,source:" + t(n) + ".split(/\\n/)[$line-1].replace(/^\\s+/,'')};}");
        try {
            var T = new Function("$data", "$filename", j);
            return T.prototype = p, T;
        } catch (k) {
            throw k.temp = "function anonymous($data,$filename) {" + j + "}", k;
        }
    }
    var i = function(e, t) {
        ...
        switch (n) {
          ...
          default:
            if (/^\s*\|\s*[\w\$]/.test(o)) {
                ...
                for (var f = 0, d = e.split("|"), p = d.length, h = d[f++]; p > f; f++) h = j(h, d[f]);
                e = (c ? "=" : "=#") + h;
...
define("conf/uc/note", [ "require", "exports", "module", "jquery", "./common", "lib/ui/box/1.0.1/box", "lib/plugins/lazyload/1.9.3/lazyload", "lib/core/1.0.0/io/request", "lib/core/1.0.0/dom/build", "plugins/pager/1.0.0/pager", "template", "lib/ui/tab/1.0.0/tab" ], function(e, t, n) {
    "use strict";
    var i = e("jquery");
    e("./common");
    var o = e("lib/ui/box/1.0.1/box"), r = (e("lib/plugins/lazyload/1.9.3/lazyload"), 
    e("lib/core/1.0.0/io/request")), a = e("lib/core/1.0.0/dom/build"), s = e("plugins/pager/1.0.0/pager"), u = e("template"), l = e("lib/ui/tab/1.0.0/tab"), c = i("#jIfmTab"), f = new l(c), d = {};
    d.callback1 = function(e) {
        if (!d.callback1.isInited) {
            d.callback1.isInited = !0;
            var t = a.build(e, !1), n = t.get("jPagination"), l = t.get("jContainer"), c = new s(n, {
        ...
        var p = {
            init: function(e, t) {
                if (!p.inited) {
                    ...
                    e.on("click", ".jEdit .jDel", function() {
                        var e = i(this), n = e.parents(".jEdit").attr("data-id");
                        o.confirm("确定删除吗？", function() {
                            p.postparams($PAGE_DATA.noteDel, {
                                id: n
                            }, "删除成功！", t);
                        }, function() {});
                    });
    ...
    f.on("change", function(e) {
        ...
        d["callback" + t] && d["callback" + t](e.body);
    });
    f.setCurrent();
});