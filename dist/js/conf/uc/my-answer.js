...
define("lib/ui/box/1.0.1/popup", [ "require", "exports", "module", "jquery", "../../../core/1.0.0/utils/util", "../../../core/1.0.0/utils/css", "../../../core/1.0.0/event/emitter" ], function(e, t, n) {
    ...
    r.inherits(i, s, {
        ...
        center: function() {
            var e = this._popup, t = this._.fixed, n = j(), i = P(), o = $(e), r = t ? 0 : n.x, a = t ? 0 : n.y, s = (i.w - o.w) / 2 + r, u = .382 * (i.h - o.h) + a;
            e.css({
                left: m(A(s), r),
                top: m(A(u), a)
            });
        ...
        alignTo: function(e, t) {
            ...
            var f = n._dirClass;
            f && r.removeClass(f);
            var d = i.fixed, p = P(), h = j(), v = z(r), m = q(r), b = E(e), x = z(a), _ = q(a), C = b.left, T = b.top, k = d ? C - h.x : C, $ = d ? T - h.y : T, I = d ? 0 : h.x, L = d ? 0 : h.y, D = I + p.w - v, N = L + p.h - m, M = {
                t: "b",
                b: "t",
                l: "r",
                r: "l"
            ...
            var V, Y, X = "top" !== O[B], J = [ "v", "h" ][1 ^ X], Z = z(H), K = q(H), ee = {}, te = X ? "left" : "top";
            switch (J) {
              case "h":
                V = y(C + (x - Z) / 2);
                ee.left = V;
...
define("conf/uc/my-answer", [ "require", "exports", "module", "jquery", "./common", "module/top-search/1.0.0/top-search", "module/login-status/1.0.0/login-status", "module/footer/1.0.0/footer", "template", "lib/ui/box/1.0.1/box", "lib/plugins/lazyload/1.9.3/lazyload", "lib/core/1.0.0/io/request", "lib/core/1.0.0/dom/build", "plugins/pager/1.0.0/pager", "lib/ui/tab/1.0.0/tab" ], function(e, t, n) {
    "use strict";
    var i = e("jquery");
    e("./common");
    var o = e("module/top-search/1.0.0/top-search"), r = e("module/login-status/1.0.0/login-status"), a = e("module/footer/1.0.0/footer"), s = e("template"), u = (new o(), 
    new r(), new a(), e("lib/ui/box/1.0.1/box")), l = (e("lib/plugins/lazyload/1.9.3/lazyload"), 
    e("lib/core/1.0.0/io/request")), c = e("lib/core/1.0.0/dom/build"), f = e("plugins/pager/1.0.0/pager"), d = e("lib/ui/tab/1.0.0/tab"), p = i("#jIfmTab"), h = new d(p), g = {}, v = !1, m = !1, y = {
        init: function(e, t) {
            if (!y.inited) {
                y.inited = !0;
                e.on("click", ".jBtnManage", function() {
                    var t = e.find(".jItem"), n = i(this);
                    if (v) {
                        v = !1;
                        n.removeClass("deleting").html("管理");
                        t.removeClass("deleting");
                    } else {
                        v = !0;
                        n.addClass("deleting").html("完成");
                        t.addClass("deleting");
                    }
                });
                e.on("click", ".jDel", function() {
                    var e = i(this).attr("data-id");
                    u.confirm("是否删除", function(n) {
                        1 == n && y.postparams($PAGE_DATA.delQusetion, {
                            id: e
                        }, "删除成功！", t);
                    }, function() {});
                });
        ...
        postparams: function(e, t, n, i) {
            l.get(e, t, function(e) {
                i.pagination.selectPage(i.pagination.get("currentPage"));
                u.ok(n);
            }, function(e) {
                u.error(e.msg || "网络错误,请重试");
            }, this);
        }
    }, b = {
        init: function(e, t) {
            if (!b.inited) {
                ...
                e.on("click", ".jDel", function() {
                    var e = i(this).attr("data-id");
                    u.confirm("是否删除", function() {
                        b.postparams($PAGE_DATA.delAnswer, {
                            id: e
                        }, "删除成功！", t);
                    }, function() {});
                });
    ...
    g.callback1 = function(e) {
        v = !1;
        if (!g.callback1.isInited) {
            g.callback1.isInited = !0;
            var t = c.build(e, !1), n = t.get("jPagination"), o = t.get("jContainer"), r = new f(n, {
                url: $PAGE_DATA.pagerQusetion,
                data: {}
            }), a = null;
            r.on("ajaxStart", function() {
                a = u.loading("正在加载...", {
                    modal: !1
                });
            });
            r.on("ajaxSuccess", function(t, n) {
                if (t && t.data && t.data.resultList && t.data.resultList.length > 0) {
                    if (v) {
                        t.data.deletingClass = "deleting";
                        t.data.deletingTxt = "完成";
                    } else {
                        t.data.deletingClass = "";
                        t.data.deletingTxt = "管理";
                    }
                    o.html(s("tModule1", t.data));
                    y.init(e, r);
                    n && n(t.data.records);
                } else {
                    o.html(s("tEmpty"));
