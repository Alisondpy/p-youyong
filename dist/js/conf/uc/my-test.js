...
define("lib/ui/box/1.0.1/popup", [ "require", "exports", "module", "jquery", "../../../core/1.0.0/utils/util", "../../../core/1.0.0/utils/css", "../../../core/1.0.0/event/emitter" ], function(e, t, n) {
    ...
    r.inherits(i, s, {
        ...
        alignTo: function(e, t) {
            ...
            var f = n._dirClass;
            f && r.removeClass(f);
            var d = i.fixed, p = E(), h = k(), g = z(r), m = q(r), b = P(e), x = z(a), _ = q(a), C = b.left, T = b.top, j = d ? C - h.x : C, $ = d ? T - h.y : T, I = d ? 0 : h.x, S = d ? 0 : h.y, D = I + p.w - g, N = S + p.h - m, M = {
                t: "b",
                b: "t",
                l: "r",
                r: "l"
...
define("conf/uc/my-test", [ "require", "exports", "module", "jquery", "./common", "template", "lib/core/1.0.0/io/request", "lib/ui/box/1.0.1/crossbox", "lib/plugins/lazyload/1.9.3/lazyload", "plugins/pager/1.0.0/pager", "module/navigation-bar/1.0.0/navigation-bar" ], function(e, t, n) {
    "use strict";
    var i = e("jquery");
    e("./common");
    var o, r, a = e("template"), s = e("lib/core/1.0.0/io/request"), u = e("lib/ui/box/1.0.1/crossbox"), l = e("lib/plugins/lazyload/1.9.3/lazyload"), c = e("plugins/pager/1.0.0/pager"), f = e("module/navigation-bar/1.0.0/navigation-bar"), d = i("#jContainer"), p = i(".jPagination"), h = $PAGE_DATA.loadTest, v = $PAGE_DATA.analysisUrl, g = (i("#jTestModule"), 
    !1), m = function(e, t) {
        g = !1;
        r && r.destroy();
        r = new c(p, {
        ...
        r.on("ajaxSuccess", function(e, t) {
            if (e && e.data && e.data.resultList && e.data.resultList.length > 0) {
                d.find(".jExamManage");
                if (g) {
                    e.data.deletingClass = "deleting";
                    e.data.deletingTxt = "完成";
                } else {
    ...
    var y = new f("#jTestStatus", {
        currentClass: "active",
        navSelector: [ "#jTestStatus" ],
        navItemSlect: "li"
    });
    ...
    var b = {
        init: function(e, t) {
            if (!b.inited) {
                b.inited = !0;
                e.on("click", ".jBtn", function() {
                    var t = i(this);
                    if (g) {
                        g = !1;
                        t.removeClass("deleting").html("管理");
                        e.find(".jExamList").removeClass("deleting");
                    } else {
                        g = !0;
                        t.addClass("deleting").html("完成");
                        e.find(".jExamList").addClass("deleting");
                    }
                });
                e.on("click", ".jBtnDel", function() {
                    var e = i(this), n = e.attr("data-id");
                    i(".ifm-tab-item.active").attr("data-value");
                    s.get(h, {
                        id: n
                    }, function(e) {
                        g = !0;
                        u.confirm("确认删除？", function(e) {
                            if (1 == e) {
                                u.ok("删除成功");
                                t.pagination.selectPage(t.pagination.get("currentPage"));
                            }
                        });
                    }, function(e) {
                ...
                e.on("click", ".jViewPage", function() {
                    var e = i(this), t = e.parents(".jExamList").attr("data-value");
                    s.get(v, {
                        examId: t
                    }, function(e) {
                        u.loadUrl(e.msg, {
