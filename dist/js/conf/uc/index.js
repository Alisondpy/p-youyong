...
!function(e, t, n) {
    ...
    var v = function(t, u) {
        ...
        r(v);
        var w = u.type || _.type, C = g.get(w);
        if ("function" != typeof C) throw "Error, cannot found the specific type loader (type: `" + w + "`)";
        "html" === w && (_.placeholder = "");
        u && e.extend(_, u);
        var A = _.container, k = _.event, T = 0 === k.indexOf("scroll"), j = A && A !== a ? e(A) : s, P = function(t) {
            var i = v._list;
            if (i.length > 0) {
                var o = 0;
                n(i.slice(0), function(t, n) {
                    var i = e(n);
                    if (!_.skipInvisible || i.is(":visible")) if (b(n, _) || x(n, _)) ; else if (m(n, _) || y(n, _)) {
            ...
            var t = this, n = e(t), i = n.attr("data-" + _.dataAttribute), o = _.sourceMaker, r = _.appear, a = _.loadingClass, s = t[c];
            if (s === f) {
                t[c] = d;
                a && n.addClass(a);
                o && (i = o(i, t));
                r && r.apply(v, [ t, i ]);
                C.call(v, t, i, _, function(e, o) {
                    if (!v._destroyed) {
                        a && n.removeClass(a);
...
define("lib/ui/box/1.0.1/popup", [ "require", "exports", "module", "jquery", "../../../core/1.0.0/utils/util", "../../../core/1.0.0/utils/css", "../../../core/1.0.0/event/emitter" ], function(e, t, n) {
    ...
    var o = e("jquery"), r = e("../../../core/1.0.0/utils/util"), a = e("../../../core/1.0.0/utils/css"), s = e("../../../core/1.0.0/event/emitter"), u = window, l = u.document, c = o(u), f = o(l), d = l.documentElement, p = /\S+/g, h = !("minWidth" in d.style), g = "ui-layer", v = u.Math, m = v.max, y = v.ceil, b = r.guid, x = r.extend, _ = r.each, w = function(e, t) {
    ...
    r.inherits(i, s, {
        ...
        center: function() {
            var e = this._popup, t = this._.fixed, n = j(), i = E(), o = P(e), r = t ? 0 : n.x, a = t ? 0 : n.y, s = (i.w - o.w) / 2 + r, u = .382 * (i.h - o.h) + a;
            e.css({
                left: m(A(s), r),
                top: m(A(u), a)
            });
        ...
        alignTo: function(e, t) {
            ...
            var f = n._dirClass;
            f && r.removeClass(f);
            var d = i.fixed, p = E(), h = j(), v = q(r), m = S(r), b = z(e), x = q(a), w = S(a), C = b.left, k = b.top, T = d ? C - h.x : C, P = d ? k - h.y : k, I = d ? 0 : h.x, L = d ? 0 : h.y, N = I + p.w - v, $ = L + p.h - m, U = {
                t: "b",
                b: "t",
                l: "r",
                r: "l"
            ...
            R[0][V] = R[0][V] + 10 * ("tl".indexOf(V) !== -1 ? -1 : 1);
            O[M[l[0]]] = A(R[0][l[0]]);
            O[M[l[1]]] = A(R[1][l[1]]);
            var B = g + "-" + V;
            r.css(O).addClass(B);
            n._dirClass = B;
            var F = n.$("arrow", 1), H = n.$("inner", 1);
            if (!F) {
                if (!H) return n;
                F = o('<div node-type="arrow" class="ui-arrow"><i></i><b></b></div>').appendTo(H);
            }
            var Q, Y, X = "top" !== M[V], J = [ "v", "h" ][1 ^ X], Z = q(F), K = S(F), ee = {}, te = X ? "left" : "top";
            switch (J) {
              case "h":
                Q = y(C + (x - Z) / 2);
                ee.left = Q;
...
define("module/uc/search-bar/search-bar", [ "require", "exports", "module", "jquery", "lib/core/1.0.0/dom/build", "lib/core/1.0.0/event/emitter", "lib/core/1.0.0/utils/util" ], function(e, t, n) {
    "use strict";
    function i(e, t) {
        var n = this, i = {
            activeClass: "focus"
        ...
        n.options = o.extend(!0, {}, i, t);
        if (void 0 === e) throw new Error("the params [selector] is required");
        n.el = o(e);
        var a = r.build(n.el, !1);
        n.ipt = a.get("ipt");
        n.btn = a.get("btn");
        n.lbl = a.get("lbl");
        n._init();
    ...
    var o = e("jquery"), r = e("lib/core/1.0.0/dom/build"), a = e("lib/core/1.0.0/event/emitter"), s = e("lib/core/1.0.0/utils/util");
    s.inherits(i, a);
    i.prototype._initEvent = function() {
        var e = this;
        e.ipt.on("focus", function() {
...
define("conf/uc/index", [ "require", "exports", "module", "jquery", "module/top-search/1.0.0/top-search", "module/login-status/1.0.0/login-status", "module/footer/1.0.0/footer", "lib/ui/box/1.0.1/box", "lib/plugins/lazyload/1.9.3/lazyload", "lib/core/1.0.0/io/request", "lib/core/1.0.0/dom/build", "plugins/pager/1.0.0/pager", "module/uc/search-bar/search-bar", "module/uc/left-menu/left-menu", "lib/ui/tab/1.0.0/tab" ], function(e, t, n) {
    "use strict";
    function i() {}
    var o = e("jquery"), r = e("module/top-search/1.0.0/top-search"), a = e("module/login-status/1.0.0/login-status"), s = e("module/footer/1.0.0/footer"), u = (new r(), 
    new a(), new s(), e("lib/ui/box/1.0.1/box")), l = (e("lib/plugins/lazyload/1.9.3/lazyload"), 
    e("lib/core/1.0.0/io/request"), e("lib/core/1.0.0/dom/build")), c = e("plugins/pager/1.0.0/pager"), f = e("module/uc/search-bar/search-bar"), d = new f("#jUcSearchBar");
    d.on("search", function(e) {
        console.log("你可以根据这个返回值来做业务:", e);
    });
    var p = e("module/uc/left-menu/left-menu"), d = new p(), h = e("lib/ui/tab/1.0.0/tab"), g = o("#jIfmTab"), v = new h(g), m = {};
    m.callback1 = function(e) {
        if (!m.callback1.isInited) {
            m.callback1.isInited = !0;
            var t = l.build(e, !1), n = t.get("jPagination"), r = t.get("jContainer"), a = new c(n, {
            ...
            a.on("change", function(e, t) {
                console.log("pageNum", e, t);
                o("#jCurrentPage").html(e);
            });
        }
    };
    m.callback2 = function(e) {
        if (!m.callback2.isInited) {
            m.callback2.isInited = !0;
            var t = l.build(e, !1), n = t.get("jPagination"), r = t.get("jContainer"), a = new c(n, {
                url: $PAGE_DATA.getPager,
                data: {
                    "class": "djune"
    ...
    v.on("change", function(e) {
        ...
        m["callback" + t] && m["callback" + t](e.body);
    });
    v.setCurrent();
});