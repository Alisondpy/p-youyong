...
define("lib/ui/box/1.0.1/popup", [ "require", "exports", "module", "jquery", "../../../core/1.0.0/utils/util", "../../../core/1.0.0/utils/css", "../../../core/1.0.0/event/emitter" ], function(e, t, n) {
    ...
    o.inherits(i, a, {
        ...
        center: function() {
            var e = this._popup, t = this._.fixed, n = T(), i = E(), r = j(e), o = t ? 0 : n.x, s = t ? 0 : n.y, a = (i.w - r.w) / 2 + o, u = .382 * (i.h - r.h) + s;
            e.css({
                left: g(_(a), o),
                top: g(_(u), s)
            });
        ...
        alignTo: function(e, t) {
            ...
            var f = n._dirClass;
            f && o.removeClass(f);
            var d = i.fixed, h = E(), p = T(), v = L(o), g = S(o), b = z(e), x = L(s), C = S(s), k = b.left, $ = b.top, q = d ? k - p.x : k, j = d ? $ - p.y : $, A = d ? 0 : p.x, N = d ? 0 : p.y, F = A + h.w - v, I = N + h.h - g, M = {
                t: "b",
                b: "t",
                l: "r",
                r: "l"
            ...
            c || w(l, function(e, t) {
                D[t][e] > B[O[e]][1] && (e = l[t] = M[e]);
                D[t][e] < B[O[e]][0] && (l[t] = M[e]);
            });
            var W = l[0];
            if (!l[1]) {
                l[1] = "left" === O[W] ? "t" : "l";
            ...
            D[0][W] = D[0][W] + 10 * ("tl".indexOf(W) !== -1 ? -1 : 1);
            P[O[l[0]]] = _(D[0][l[0]]);
            P[O[l[1]]] = _(D[1][l[1]]);
            var V = m + "-" + W;
            o.css(P).addClass(V);
            n._dirClass = V;
            var Z = n.$("arrow", 1), U = n.$("inner", 1);
            if (!Z) {
                if (!U) return n;
                Z = r('<div node-type="arrow" class="ui-arrow"><i></i><b></b></div>').appendTo(U);
            }
            var Y, X, Q = "top" !== O[W], G = [ "v", "h" ][1 ^ Q], J = L(Z), K = S(Z), ee = {}, te = Q ? "left" : "top";
            switch (G) {
              case "h":
                Y = y(k + (x - J) / 2);
                ee.left = Y;
...
!function() {
    ...
    function n(n, i) {
        ...
        var s = i.debug, a = i.openTag, u = i.closeTag, l = i.parser, c = i.compress, f = i.escape, d = 1, m = {
            $data: 1,
            $filename: 1,
            $utils: 1,
            $helpers: 1,
        ...
        try {
            var q = new Function("$data", "$filename", $);
        ...
        switch (n) {
          ...
          default:
            if (/^\s*\|\s*[\w\$]/.test(r)) {
                ...
                for (var f = 0, d = e.split("|"), h = d.length, p = d[f++]; h > f; f++) p = $(p, d[f]);
                e = (c ? "=" : "=#") + p;
