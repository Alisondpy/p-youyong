...
define("module/hot-activity/1.0.0/hot-activity", [ "require", "exports", "module", "jquery", "lib/core/1.0.0/event/emitter", "lib/core/1.0.0/utils/util", "template", "lib/core/1.0.0/io/request", "lib/plugins/lazyload/1.9.3/lazyload" ], function(e, t, n) {
    "use strict";
    function i(e, t) {
        var n = this, i = {
            url: null,
    ...
    var o, r = e("jquery"), a = (e("lib/core/1.0.0/event/emitter"), e("lib/core/1.0.0/utils/util"), 
    e("template")), s = e("lib/core/1.0.0/io/request"), u = e("lib/plugins/lazyload/1.9.3/lazyload");
    i.prototype._init = function() {
        var e = this, t = e.options, n = e.el;
        n.html("this is loading...");
        s.get(t.url, function(i) {
            if (!t.url) throw new Error("the url of defaults is required");
            i.data.list.length <= 0 ? n.html("暂时没有热门活动！") : e._template(i, t.numClass);
        }, function(e) {
            n.html('<p>网络错误，请点击<a class="jReload">重新加载</a></p>');
        });
    };
    i.prototype._reload = function() {
        var e = this;
        e.on("click", "jReload", function() {
            e._init();
        });
    };
    i.prototype._template = function(e) {
        var t = this, n = t.el, i = t.options, s = i.numClass;
        i.formatNum && r.each(e.data.list, function(e, n) {
            r.each(n, function(e, i) {
                e == s && (n[e] = t._formatNum(n[e]));
            });
        });
        var l = a(i.temId, e.data);
        n.html(l);
        o = new u(n.find(r(".jImg")), {
            mouseWheel: !0,
            effect: "fadeIn",
            snap: !0
        });
    };
    i.prototype._formatNum = function(e) {
        for (var t = "", n = 0, i = e.length - 1; i >= 0; i--) {
            t = n % 3 == 0 && 0 != n ? e.charAt(i) + ", " + t : e.charAt(i) + t;
            n++;
        }
        e = t;
        return e;
...
define("conf/news/index", [ "require", "exports", "module", "jquery", "lib/ui/box/1.0.1/box", "lib/plugins/lazyload/1.9.3/lazyload", "lib/core/1.0.0/io/request", "template", "plugins/pager/1.0.0/pager", "module/hot-activity/1.0.0/hot-activity", "module/top-search/1.0.0/top-search", "module/login-status/1.0.0/login-status", "module/fix-bar/1.0.0/fix-bar", "module/footer/1.0.0/footer" ], function(e, t, n) {
    "use strict";
    function i(e, t, n, i, o) {
        ...
        a.on("ajaxSuccess", function(e, t) {
            if (!s.isEmptyObject(e.data) && e.data && e.data.resultList && e.data.resultList.length > 0) {
                var a = c(n, e.data);
                document.getElementById(i).innerHTML = a;
                r = new l(s("#" + i).find(".jImg"), {
                    mouseWheel: !0,
                    effect: "fadeIn",
                    snap: !0
                });
    ...
    function o() {
        var e = s("#jNewsNav").find(".current").attr("data-value");
        i($PAGE_DATA.loadNews, {
            type: e
        }, "jWrap", "jWrapBox", v);
    }
    var r, a, s = e("jquery"), u = e("lib/ui/box/1.0.1/box"), l = e("lib/plugins/lazyload/1.9.3/lazyload"), c = (e("lib/core/1.0.0/io/request"), 
    e("template")), f = e("plugins/pager/1.0.0/pager"), d = (e("module/hot-activity/1.0.0/hot-activity"), 
    e("module/top-search/1.0.0/top-search")), p = e("module/login-status/1.0.0/login-status"), h = e("module/fix-bar/1.0.0/fix-bar"), g = e("module/footer/1.0.0/footer"), v = (new d(), 
    new p(), new h(), new g(), s("#jPagination"));
    o();
    s(".mod-wrap .mod-sub-nav a").click(function() {
        s(this).addClass("current").siblings().removeClass("current");
