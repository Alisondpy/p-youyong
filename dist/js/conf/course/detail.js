...
define("lib/ui/box/1.0.1/popup", [ "require", "exports", "module", "jquery", "../../../core/1.0.0/utils/util", "../../../core/1.0.0/utils/css", "../../../core/1.0.0/event/emitter" ], function(e, t, n) {
    ...
    r.inherits(i, s, {
        ...
        center: function() {
            var e = this._popup, t = this._.fixed, n = k(), i = $(), o = P(e), r = t ? 0 : n.x, a = t ? 0 : n.y, s = (i.w - o.w) / 2 + r, u = .382 * (i.h - o.h) + a;
            e.css({
                left: m(C(s), r),
                top: m(C(u), a)
            });
        ...
        alignTo: function(e, t) {
            ...
            r.css(M).addClass(F);
            n._dirClass = F;
            var H = n.$("arrow", 1), Q = n.$("inner", 1);
            if (!H) {
                if (!Q) return n;
                H = o('<div node-type="arrow" class="ui-arrow"><i></i><b></b></div>').appendTo(Q);
            }
            var V, Y, X = "top" !== W[B], J = [ "v", "h" ][1 ^ X], Z = z(H), K = q(H), ee = {}, te = X ? "left" : "top";
            switch (J) {
              case "h":
                V = y(A + (x - Z) / 2);
                ee.left = V;
...
!function(e, t, n) {
    ...
    var v = function(t, u) {
        ...
        u && e.extend(w, u);
        var C = w.container, T = w.event, j = 0 === T.indexOf("scroll"), k = C && C !== a ? e(C) : s, P = function(t) {
            var i = v._list;
            if (i.length > 0) {
                var o = 0;
...
define("conf/course/detail", [ "require", "exports", "module", "jquery", "lib/ui/box/1.0.1/crossbox", "lib/plugins/lazyload/1.9.3/lazyload", "lib/core/1.0.0/io/request", "lib/ui/tab/1.0.0/tab", "template", "plugins/pager/1.0.0/pager", "module/navigation-bar/1.0.0/navigation-bar", "lib/core/1.0.0/io/cookie", "module/login-status/1.0.0/login", "module/top-search/1.0.0/top-search", "module/login-status/1.0.0/login-status", "module/fix-bar/1.0.0/fix-bar", "module/footer/1.0.0/footer" ], function(e, t, n) {
    "use strict";
    function i(e, t, n, i, o) {
        "undefined" != typeof _ && _.destroy();
        _ = new d(o, {
            url: e,
            data: t,
            options: {
        ...
        var r = null;
        _.on("ajaxStart", function() {
            r = s.loading("正在加载...", {
                modal: !1
            });
        });
        _.on("ajaxSuccess", function(e, t) {
        ...
        _.on("ajaxError", function(e) {
            document.getElementById(i).innerHTML = "<div style='color: #000;'>请求超时请重试！<a href=''>刷新</a></div>";
            r && r.hide();
        });
        _.on("change", function(e, t) {});
    }
    function o() {
        var e = a("#jSubNav").find(".current").attr("data-type");
    ...
    var a = e("jquery"), s = e("lib/ui/box/1.0.1/crossbox"), u = e("lib/plugins/lazyload/1.9.3/lazyload"), l = e("lib/core/1.0.0/io/request"), c = e("lib/ui/tab/1.0.0/tab"), f = e("template"), d = e("plugins/pager/1.0.0/pager"), p = (e("module/navigation-bar/1.0.0/navigation-bar"), 
    e("lib/core/1.0.0/io/cookie"), e("module/login-status/1.0.0/login")), h = e("module/top-search/1.0.0/top-search"), g = e("module/login-status/1.0.0/login-status"), v = e("module/fix-bar/1.0.0/fix-bar"), m = e("module/footer/1.0.0/footer"), y = (new h(), 
    new g(), new v(), new m(), $PAGE_DATA.sourceId), b = $PAGE_DATA.toQuestionPage, x = a("#jPagination");
    a(".jWrap2").on("click", "#jQuestion", function() {
        p.isLogin() ? s.loadUrl(b + "?id=" + y, {
            title: "提问页面",
            autoRelease: !0,
            modal: !1
    ...
    a("#jWrap1Box,#jWrap3Box").on("click", ".mod-item .like", function() {
        if (p.isLogin()) {
            var e, t = a(this).attr("data-dataType"), n = a(this).attr("data-type"), i = a(this).attr("data-value");
            if (a(this).hasClass("activeLike")) {
                e = {
                    dataType: t,
                    type: n,
                    id: i
    ...
    a("#jWrap3Box").on("click", ".mod-item .pick", function() {
        if (p.isLogin()) {
            var e = a(this).attr("data-id");
            if (a(this).hasClass("picked")) {
                r($PAGE_DATA.baseStaticUrl + "source/api/course/details.json", e, "取消采集");
                a(this).find("i").text("采集");
                a(this).removeClass("picked");
            } else {
                r($PAGE_DATA.baseStaticUrl + "source/api/course/details.json", e, "采集");
                a(this).find("i").text("已采集");
