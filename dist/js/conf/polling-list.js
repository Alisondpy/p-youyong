...
define("lib/core/1.0.0/dom/dataset", [ "require", "exports", "module", "jquery" ], function(t, e, n) {
    ...
    var a = (window.document, t("jquery")), s = /^-ms-/, l = /-([\da-z])/gi, u = function(t, e) {
        ...
        if (1 === arguments.length) {
            if (l = t.dataset) {
                u = {};
                for (s in l) l.hasOwnProperty(s) && (u[s] = r(l[s]));
                return u;
            }
            l = t.attributes;
            a = l.length;
...
define("lib/core/1.0.0/dom/build", [ "require", "exports", "module", "jquery", "./dataset" ], function(t, e, n) {
    ...
    var r = window.document, o = t("jquery"), a = function(t, e, n) {
        var a, s, l, u, c, f = function(t) {
            if (n) for (var r in n) l[r] = o(n[r].toString(), t); else {
                l = {};
                u = o("[node-type]", t);
...
define("module/login-status/1.0.0/login", [ "require", "exports", "module", "lib/core/1.0.0/io/cookie" ], function(t, e, n) {
    "use strict";
    var i = t("lib/core/1.0.0/io/cookie"), r = "_nick", o = "_ui_", a = $PAGE_DATA && $PAGE_DATA.LOGIN_URL || "", s = $PAGE_DATA && $PAGE_DATA[r] || null;
    e.getNick = function() {
        return s;
    };
    e.isLogin = function() {
...
!function(t, e, n) {
    ...
    var n = t.each, i = function(t, e) {
        ...
        return e;
    }, a = window, s = t(a), l = a.Image, u = /(?:iphone|ipod|ipad).*os 5/gi.test(navigator.appVersion), c = "__lazy_status__", f = 0, p = 1, d = 2, h = function(t) {
        return t[c] === e;
    }, v = function() {
    ...
    var m = function(e, l) {
        ...
        o(m);
        var x = l.type || _.type, w = v.get(x);
        if ("function" != typeof w) throw "Error, cannot found the specific type loader (type: `" + x + "`)";
        "html" === x && (_.placeholder = "");
        l && t.extend(_, l);
        var j = _.container, $ = _.event, E = 0 === $.indexOf("scroll"), T = j && j !== a ? t(j) : s, L = function(e) {
            var i = m._list;
            if (i.length > 0) {
                var r = 0;
            ...
            var e = this, n = t(e), i = n.attr("data-" + _.dataAttribute), r = _.sourceMaker, o = _.appear, a = _.loadingClass, s = e[c];
            if (s === f) {
                e[c] = p;
                a && n.addClass(a);
                r && (i = r(i, e));
    ...
    var g = function(e, n) {
        var i, r = n.container;
        i = r && r !== a ? t(r).offset().top + t(r).height() : (a.innerHeight ? a.innerHeight : s.height()) + s.scrollTop();
        return i <= t(e).offset().top - n.threshold;
    }, y = function(e, n) {
        var i, r = n.container;
        i = r && r !== a ? t(r).offset().left + t(r).width() : s.width() + s.scrollLeft();
        return i <= t(e).offset().left - n.threshold;
    }, b = function(e, n) {
        var i, r = n.container;
        i = r && r !== a ? t(r).offset().top : s.scrollTop();
        return i >= t(e).offset().top + n.threshold + t(e).height();
    }, A = function(e, n) {
        var i, r = n.container;
        i = r && r !== a ? t(r).offset().left : s.scrollLeft();
...
!function(t, e) {
    ...
    function r(t, e, n, i) {
        ...
        if (e) for (var o, a, s, l = -1, u = {
            ...
            s = o[m] || i;
            try {
                r = o[g] === h ? a.call(s, u, n) !== !1 && r : a.apply(s, n) !== !1 && r;
            } catch (f) {
                setTimeout(function() {
                    console.error(f);
                }, 1);
    ...
    b.removeListener = function(t, e, n) {
        ...
        for (;r = t.shift(); ) {
            ...
            if (o) if (e || n) for (a = o.length; --a >= 0; ) {
                l = o[a];
                c = l[v];
                e && c !== e && (void 0 === c.guid || c.guid !== e.guid) || n && l[m] !== n || o.splice(a, 1);
            } else delete i[r];
        }
        return this;
    };
    ...
    b.emit = function(t) {
        ...
        for (;n = t.shift(); ) {
            (i = e.all) && (i = i.slice());
            (o = e[n]) && (o = o.slice());
            "all" !== n && (c = r(n, o, l, this) && c);
            c = r(n, i, [ n ].concat(l), this) && c;
        }
        return c;
    };
...
define("lib/core/1.0.0/io/request", [ "require", "exports", "module", "jquery", "../utils/util", "../event/emitter" ], function(t, e, n) {
    "use strict";
    var i = t("jquery"), r = t("../utils/util"), o = t("../event/emitter"), a = r.setImmediate, s = r.noop, l = r.extend, u = i.trim, c = i.parseJSON, f = function(t, e, n) {
        return function(i, r) {
            try {
    ...
    l(h.prototype, {
        send: function() {
            ...
            n.complete = function(n, r) {
                var o, a = +n.status, s = n.responseJSON, l = {
                    error: "1",
                ...
                f ? t.emit("response", null, o) : t.emit("error", s, o);
                t.emit("end", o);
                t.destroy();
            };
            d(t, n);
    ...
    e.ajax = function(t, e, n) {
        ...
        }, l = f(e.error || s, null, o), u = f(e.success || s, null, o);
        if (p("request", r, n) !== !1) {
            if (n && (n = i(n))) {
            ...
            r.on("response", function(t, e) {
                e = e.data;
                p("response", e) !== !1 && (t ? l(t) : e && 0 === +(e.error || 0) ? u(e) : l(e));
            });
            return r.send();
        }
    };
...
define("plugins/polling-list/1.0.0/polling", [ "require", "exports", "module", "jquery", "lib/core/1.0.0/io/request", "lib/core/1.0.0/event/emitter", "lib/core/1.0.0/utils/util" ], function(t, e, n) {
    ...
    var r = t("jquery"), o = t("lib/core/1.0.0/io/request"), a = t("lib/core/1.0.0/event/emitter"), s = t("lib/core/1.0.0/utils/util");
    s.inherits(i, a);
...
define("plugins/polling-list/1.0.0/polling-list", [ "require", "exports", "module", "jquery", "lib/core/1.0.0/io/request", "lib/core/1.0.0/event/emitter", "lib/core/1.0.0/utils/util", "./polling" ], function(t, e, n) {
    ...
    var r = t("jquery"), o = (t("lib/core/1.0.0/io/request"), t("lib/core/1.0.0/event/emitter")), a = t("lib/core/1.0.0/utils/util"), s = t("./polling");
    a.inherits(i, o);
    i.prototype._init = function() {
        var t = this;
...
!function() {
    ...
    function n(n, i) {
        ...
        var a = i.debug, s = i.openTag, l = i.closeTag, u = i.parser, c = i.compress, f = i.escape, p = 1, v = {
            $data: 1,
            $filename: 1,
            $utils: 1,
            $helpers: 1,
    ...
    r.parser = function(t) {
        ...
        switch (n) {
          ...
          case "each":
            var o = e[0] || "$data", a = e[1] || "as", s = e[2] || "$value", l = e[3] || "$index", u = s + "," + l;
...
define("module/monitor/1.0.0/question", [ "require", "exports", "module", "jquery", "./../../../plugins/polling-list/1.0.0/polling-list", "lib/core/1.0.0/io/request", "lib/core/1.0.0/event/emitter", "lib/core/1.0.0/utils/util", "template" ], function(t, e, n) {
    ...
    var r = t("jquery"), o = t("./../../../plugins/polling-list/1.0.0/polling-list"), a = t("lib/core/1.0.0/io/request"), s = t("lib/core/1.0.0/event/emitter"), l = t("lib/core/1.0.0/utils/util"), u = t("template");
    l.inherits(i, s);
    i.prototype._init = function() {
        var t = this;
    ...
    i.prototype._initMouse = function() {
        var t = this;
        if (!t._initMouseInited) {
            t._initMouseInited = !0;
    ...
    i.prototype._initEvent = function() {
        ...
        t.pollingList.on("success", function(e) {
            if (e && e.data && e.data.resultList && e.data.resultList.length > 0) {
                t._initMouse();
                t.min = e.data.resultList[e.data.resultList.length - 1].id;
        ...
        t.pollingList.on("pullup", function(n) {
            if (!t._isPulling) {
                t._isPulling = !0;
                a[e.type](e.url, r.extend({}, e.data, {
                    id: t.min
                }), function(e) {
                    if (e && e.data && e.data.resultList && e.data.resultList.length > 0) {
                        t.min = e.data.resultList[e.data.resultList.length - 1].id;
...
define("conf/polling-list", [ "require", "exports", "module", "jquery", "module/top-search/1.0.0/top-search", "module/login-status/1.0.0/login-status", "module/fix-bar/1.0.0/fix-bar", "module/footer/1.0.0/footer", "module/monitor/1.0.0/question" ], function(t, e, n) {
    "use strict";
    var i = t("jquery"), r = t("module/top-search/1.0.0/top-search"), o = t("module/login-status/1.0.0/login-status"), a = t("module/fix-bar/1.0.0/fix-bar"), s = t("module/footer/1.0.0/footer"), l = (new r(), 
    new o(), new a(), new s(), t("module/monitor/1.0.0/question")), u = new l("#jPollingList1", {
        pollingAjax: {
