...
define("lib/ui/box/1.0.1/popup", [ "require", "exports", "module", "jquery", "../../../core/1.0.0/utils/util", "../../../core/1.0.0/utils/css", "../../../core/1.0.0/event/emitter" ], function(e, t, n) {
    ...
    r.inherits(i, s, {
        ...
        alignTo: function(e, t) {
            ...
            var f = n._dirClass;
            f && r.removeClass(f);
            var d = i.fixed, p = P(), h = k(), v = I(r), m = q(r), b = E(e), x = I(a), _ = q(a), C = b.left, T = b.top, j = d ? C - h.x : C, $ = d ? T - h.y : T, z = d ? 0 : h.x, S = d ? 0 : h.y, N = z + p.w - v, L = S + p.h - m, O = {
                t: "b",
                b: "t",
                l: "r",
                r: "l"
            ...
            c || w(l, function(e, t) {
                R[t][e] > G[M[e]][1] && (e = l[t] = O[e]);
                R[t][e] < G[M[e]][0] && (l[t] = O[e]);
            });
            var F = l[0];
            if (!l[1]) {
                l[1] = "left" === M[F] ? "t" : "l";
            ...
            var Q, Y, X = "top" !== M[F], J = [ "v", "h" ][1 ^ X], Z = I(H), K = q(H), ee = {}, te = X ? "left" : "top";
            switch (J) {
              case "h":
                Q = y(C + (x - Z) / 2);
                ee.left = Q;
...
define("conf/subject/sub-list", [ "require", "exports", "module", "jquery", "template", "lib/core/1.0.0/io/request", "lib/ui/box/1.0.1/box", "lib/plugins/lazyload/1.9.3/lazyload", "plugins/pager/1.0.0/pager", "module/navigation-bar/1.0.0/navigation-bar", "module/top-search/1.0.0/top-search", "module/login-status/1.0.0/login-status", "module/fix-bar/1.0.0/fix-bar", "module/footer/1.0.0/footer" ], function(e, t, n) {
    "use strict";
    var i, o, r = e("jquery"), a = e("template"), s = (e("lib/core/1.0.0/io/request"), 
    e("lib/ui/box/1.0.1/box")), u = e("lib/plugins/lazyload/1.9.3/lazyload"), l = e("plugins/pager/1.0.0/pager"), c = e("module/navigation-bar/1.0.0/navigation-bar"), f = e("module/top-search/1.0.0/top-search"), d = e("module/login-status/1.0.0/login-status"), p = e("module/fix-bar/1.0.0/fix-bar"), h = e("module/footer/1.0.0/footer"), g = (new f(), 
    new d(), new p(), new h(), r("#jContainer")), v = r(".jPagination"), m = $PAGE_DATA.loadActivity, y = function(e, t) {
        "undefined" != typeof o && o.destroy();
        o = new l(v, {
            url: e,
            data: t,
            options: {
        ...
        var n = null;
        o.on("ajaxStart", function() {
            n = s.loading("正在加载。。。", {
                modal: !1
            });
        });
        o.on("ajaxSuccess", function(e, t) {
        ...
        o.on("ajaxError", function(e) {
            s.error(e.msg || "网络错误，请重试！");
            n && n.hide();
        });
        o.on("change", function(e, t) {
            r("#jCurrentPage").html(e);
        });
    };
    y(m, {
        type: 0,
    ...
    var b = new c("#jActivity", {
        currentClass: "active",
        navSelector: [ "#jActClassify", "#jActTime" ],
        navItemSlect: "a"
    });
